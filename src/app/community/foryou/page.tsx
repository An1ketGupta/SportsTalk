...
export default function Main() {
    return (
        <div className="grid w-full h-screen grid-cols-[auto_88vh_1fr]">
            {/* Sidebar */}
            <div className="border-r border-white border-opacity-20 pr-3 pl-3 xl:pl-[16vh] xl:pr-10 h-screen overflow-hidden">
                <Sidebar />
            </div>

            {/* Main Content */}
            <div className="border-r border-white border-opacity-20 overflow-y-auto scrollbar-hide">
