...
export async function NFLMatchesHandler() {
    ...
    {matchData.length === 0 ? (
      <div className="col-span-full text-center py-20">
        <div className="text-gray-400 text-lg font-medium">Loading NFL games...</div>
        <p className="text-gray-500 text-sm mt-2">Fetching live football scores and game data</p>
      </div>
    ) : (
      matchData.map((item) => {
        ...
        return (
          ...
          >
            ...
            <div className="space-y-2 text-xs text-gray-400 mb-4">
              ...
              <div className="flex items-center gap-2">
                <span>🗓</span>
                <span>{game.date.date} {game.date.time} ({game.date.timezone})</span>
              </div>
            </div>
