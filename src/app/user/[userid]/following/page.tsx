        ...
        <>
            ...
            <div className="mt-2">
                <div className="flex border-b border-white/20">
                    <Link href={`/user/${userId}/followers`} className="flex-1 text-center py-4 text-gray-500 hover:bg-white/5 hover:text-white transition-colors">
                        Followers
                    </Link>
                ...
                <UserList users={formattedUsers} emptyMessage="This user is not following anyone yet." />
            </div>
        </>
    );
}
