...
export default function Sidebar({
    ...
    return <div className={`hidden md:flex flex-col items-end xl:items-start w-auto gap-4 lg:gap-6 pt-4 border-r border-white border-opacity-20 pr-2 pl-2 lg:pr-3 lg:pl-3 ${isMessagesPage ? "xl:pl-3 xl:pr-3" : "xl:pl-[8vh] 2xl:pl-[16vh] xl:pr-6 2xl:pr-10"} min-h-screen`}>
