...
export default function Sidebar() {
    return <div className="flex flex-col items-end xl:items-start w-auto gap-6 pt-4 border-r pt-[10vh] border-white border-opacity-20 pr-3 pl-3 xl:pl-[16vh] xl:pr-10 h-screen">
