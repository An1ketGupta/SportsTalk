...
export default function LandingBody() {
    return <div className="bg-[#1e293b] min-h-screen py-24 px-4 sm:px-6 lg:px-8">
        <div className="">
            <div className="h-auto w-full flex flex-col gap-6 lg:gap-8 lg:flex-row">
                <SquareBox bg="#353f4f" height="auto" width="auto" paddingx="1vh" paddingy="6vh">
                    <div className="px-4 sm:px-6 lg:px-8 flex flex-col justify-center" >
                        ...
                        <div className="flex my-2 gap-2 flex-wrap">
                            <SquareBox bg="#495261" height="auto" width="auto" paddingx="2vw">Hi there</SquareBox>
                            <SquareBox bg="#495261" height="auto" width="auto" paddingx="2vw">Hi there</SquareBox>
                            <SquareBox bg="#495261" height="auto" width="auto" paddingx="2vw">Hi there</SquareBox>
                        </div>
                    </div>
                ...
                <div className="flex h-auto flex-col justify-between gap-4 lg:gap-0">
                    <SquareBox bg="#1b1b1c" height="auto" width="auto" paddingx="auto">
                        <div className="py-4 px-4 sm:px-6 lg:px-10 flex flex-col gap-2 items-center justify-center" >
                            ...
                            <div className="font-semibold my-2 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center">
                                Real-time discussions during matches
                            </div>
                            <div className="flex my-2 gap-2 flex-wrap justify-center">
                                <SquareBox bg="#151515" height="auto" width="auto" paddingx="2vw">
                                    <div className="font-bold px-12 text-lg sm:text-xl lg:text-2xl">
                                        8
                                    </div>
                                ...
                                <SquareBox bg="#151515" height="auto" width="auto" paddingx="2vw">
                                    <div className="font-bold px-10 text-lg sm:text-xl lg:text-2xl">
                                        24/7
                                    </div>
                                    <div className="text-xs sm:text-sm">
                                        Active
                    ...
                    <div className="mt-4 lg:mt-0">
                        <SquareBox bg="#353f4f" height="auto" width="auto">
            ...
            <div className="mt-8 lg:mt-12">
                <SquareBox bg="#353f4f" height="auto" width="auto" paddingx="0vh">
